          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {[1, 2, 3, 4].map((i) => (
                  <Skeleton key={i} variant="rectangular" width={64} height={64} className="rounded-lg" />
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <Skeleton variant="rectangular" height={48} className="flex-1 rounded-lg" />
              <Skeleton variant="rectangular" height={48} className="flex-1 rounded-lg" />
            </div>
            <div className="flex flex-col gap-2 sm:gap-3 md:flex-row">
              <Skeleton variant="rectangular" height={48} className="w-full md:w-1/3 rounded-lg" />
