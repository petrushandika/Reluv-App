...
const VerificationForm = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const validationResult = verificationSchema.safeParse({ email });
        ...
        <>
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Didn't receive the email? We'll send you a new verification link.
            </p>
          </div>
        ...
        <>
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
              Please check your inbox and click the verification link. Didn't
