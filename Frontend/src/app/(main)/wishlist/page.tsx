...
import { WishlistItem } from "@/features/(main)/wishlist/types";
import WishlistSkeleton from "@/shared/components/common/WishlistSkeleton";
                  ...
                  <div className="p-2.5 sm:p-3 md:p-4">
                    <Link href={`/product/${product.slug}`}>
                      <div className="text-left cursor-pointer">
                        <p className="font-semibold text-xs sm:text-sm text-gray-700 dark:text-gray-300 mb-0.5 sm:mb-1">
                          {product.store?.name || "Reluv"}
                        </p>
                        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate mb-1.5 sm:mb-2">
                          {product.name}
                        </p>
