        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:border-emerald-200 dark:hover:border-emerald-900/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-semibold text-slate-500 dark:text-slate-400">Store Revenue</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-emerald-600 font-medium flex items-center mt-1">
                <span className="bg-emerald-100 dark:bg-emerald-500/20 px-1 rounded mr-1">+12.1%</span>
                <span className="text-slate-400 dark:text-slate-500 font-normal">from last month</span>
              </p>
            </CardContent>
          </Card>
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:border-sky-200 dark:hover:border-sky-900/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-semibold text-slate-500 dark:text-slate-400">Active Products</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">2 drafts awaiting approval</p>
            </CardContent>
          </Card>
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:border-amber-200 dark:hover:border-amber-900/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-semibold text-slate-500 dark:text-slate-400">Store Rating</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">Based on 128 verified reviews</p>
            </CardContent>
          </Card>
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:border-indigo-200 dark:hover:border-indigo-900/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-semibold text-slate-500 dark:text-slate-400">Order Velocity</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">4 orders need shipment today</p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="lg:col-span-4 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md">
            <CardHeader className="flex flex-row items-center justify-between pb-4 border-b border-slate-50 dark:border-slate-800/50">
              <div className="space-y-1">
                <CardTitle className="text-xl font-bold text-slate-900 dark:text-white">Sales Revenue</CardTitle>
              ...
              <div className="flex items-center space-x-2 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
                <button className="px-3 py-1 text-[10px] font-bold uppercase tracking-wider bg-white dark:bg-slate-700 text-slate-900 dark:text-white rounded shadow-sm">Monthly</button>
                <button className="px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-slate-400 hover:text-slate-600 transition-colors">Weekly</button>
              </div>
            </CardHeader>
            ...
            <CardHeader className="pb-4 border-b border-slate-50 dark:border-slate-800/50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-sm font-medium text-slate-500">
                    You have <span className="text-sky-500 font-bold">12 orders</span> to process.
                  </CardDescription>
                </div>
