    ...
    <DashboardShell 
      ...
      actions={
        <div className="flex items-center space-x-2">
          ...
          <Button className="bg-sky-500 hover:bg-sky-600 text-white transition-all active:scale-95 border-none font-bold text-[10px] uppercase tracking-widest h-10 px-4 rounded-xl">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="p-5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-between group">
            <div>
              ...
              <h3 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">124</h3>
            </div>
          ...
          <div className="p-5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-between group">
            <div>
              ...
              <h3 className="text-3xl font-black text-emerald-500 tracking-tight">92</h3>
            </div>
          ...
          <div className="p-5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-between group">
            <div>
              ...
              <h3 className="text-3xl font-black text-rose-500 tracking-tight">12</h3>
            </div>
