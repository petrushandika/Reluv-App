      ...
      <div className="bg-white dark:bg-gray-900 min-h-screen">
        <div className="container mx-auto px-4 sm:px-6 md:px-10 xl:px-20 2xl:px-40 py-8 sm:py-12 md:py-16">
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-lg shadow-sm p-6 sm:p-8 md:p-12 text-center border border-gray-200/50 dark:border-gray-700/50">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-black dark:text-white mb-2 glossy-text-strong">
            ...
            <Link
              href="/"
              className="bg-sky-600/90 dark:bg-sky-500/90 backdrop-blur-sm text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-md hover:bg-sky-700/90 dark:hover:bg-sky-600/90 transition-colors w-full sm:w-auto inline-block text-center cursor-pointer font-medium text-sm sm:text-base touch-manipulation shadow-md glossy-text-strong"
            >
              Explore Products
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 md:px-10 xl:px-20 2xl:px-40 py-10 sm:py-12 md:py-14">
        <div className="flex justify-between items-center mb-4 sm:mb-6 md:mb-8">
          <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-black dark:text-white glossy-text-title">
            My Wishlist
          </h1>
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-lg shadow-sm border border-gray-200/50 dark:border-gray-700/50 p-3 sm:p-4 md:p-6">
                  ...
                  <div className="p-2.5 sm:p-3 md:p-4">
                    <Link href={`/product/${product.slug}`}>
                      <div className="text-left cursor-pointer">
                        ...
                        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 truncate mb-1.5 sm:mb-2 glossy-text">
                          {product.name}
                        </p>
                        {firstVariant?.compareAtPrice ? (
                          <div className="mt-1 flex items-baseline flex-wrap gap-x-1.5 sm:gap-x-2">
                            <p className="font-bold text-red-600 dark:text-red-400 text-sm sm:text-base glossy-text-strong">
                          ...
                          <p className="font-bold text-gray-900 dark:text-white text-sm sm:text-base glossy-text-strong">
                            {firstVariant
                              ? formatPrice(firstVariant.price)
                              : "Price unavailable"}
                          </p>
