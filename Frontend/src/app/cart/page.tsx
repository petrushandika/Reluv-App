      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        <div className="container mx-auto px-6 md:px-20 xl:px-40 py-12 md:py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 md:p-12 text-center border border-gray-200 dark:border-gray-700">
            <ShoppingBag className="w-12 h-12 md:w-16 md:h-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
            ...
            <Link
              href="/"
              className="bg-sky-500 dark:bg-sky-600 text-white px-6 py-3 rounded-md hover:bg-sky-600 dark:hover:bg-sky-700 transition-colors w-full sm:w-auto inline-block text-center cursor-pointer"
            >
              Continue Shopping
            </Link>
          </div>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
                      <div className="flex-shrink-0 w-full sm:w-auto">
                        <img
                          ...
                          className="w-full sm:w-20 md:w-24 h-48 sm:h-20 md:h-24 object-cover rounded-lg bg-gray-100 dark:bg-gray-700"
                        />
                      </div>
                      ...
                      <div className="flex-grow w-full">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start space-y-2 sm:space-y-0">
                          <div className="flex-grow">
                            <p className="text-xs md:text-sm font-medium text-sky-600 dark:text-sky-400">
                              {item.variant.product.store?.name || "Reluv"}
                            </p>
                            <h3 className="text-sm md:text-base font-semibold text-black dark:text-white mt-1 line-clamp-2">
                              {item.variant.product.name}
                            </h3>
                            <div className="flex flex-wrap items-center gap-x-4 mt-2 text-xs md:text-sm text-gray-500 dark:text-gray-400">
                              {item.variant.size && (
                          ...
                          <div className="flex items-center justify-between sm:justify-end">
                            ...
                            <div className="flex items-center space-x-2 md:space-x-3">
                              <button
                                ...
                                className="p-1 md:p-1.5 rounded-md border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
                              >
                                <Minus className="w-3 h-3 md:w-4 md:h-4 text-gray-700 dark:text-gray-300" />
                              </button>

                              <span className="text-base md:text-lg font-semibold min-w-[2rem] text-center text-black dark:text-white">
                                {item.quantity}
                              </span>
                              ...
                              <button
                                ...
                                className="p-1 md:p-1.5 rounded-md border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
                              >
                                <Plus className="w-3 h-3 md:w-4 md:h-4 text-gray-700 dark:text-gray-300" />
                              </button>
                            </div>
                          </div>
                        </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 md:p-6 lg:sticky lg:top-4 border border-gray-200 dark:border-gray-700">
              <h2 className="text-base md:text-lg font-semibold text-black dark:text-white mb-4">
                Order Summary
              </h2>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-3 md:pt-4 mb-4 md:mb-6">
              ...
              <div className="space-y-3">
                <Link
                  href="/checkout"
                  className="block w-full bg-sky-500 dark:bg-sky-600 text-white text-center py-3 px-4 rounded-md font-medium hover:bg-sky-600 dark:hover:bg-sky-700 transition-colors text-sm md:text-base cursor-pointer"
                >
                  Proceed to Checkout
                </Link>
                ...
                <Link
                  href="/"
                  className="block w-full text-black dark:text-white text-center border border-gray-300 dark:border-gray-600 py-3 px-4 rounded-md font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm md:text-base cursor-pointer"
                >
                  Continue Shopping
                </Link>
              </div>

              <div className="mt-4 md:mt-6 text-xs text-gray-500 dark:text-gray-400 space-y-1 md:space-y-2">
                <div className="flex items-center space-x-2">
