          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-light text-gray-800 dark:text-white leading-tight">
                  {product.name}
                </h2>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2 text-sm">
                  <div className="w-4 h-4 bg-sky-600 dark:bg-sky-500 rounded-sm flex items-center justify-center">
              ...
              <div className="flex items-center space-x-4 pt-4">
                ...
                <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800">
                  <button
                    ...
                    className="px-4 py-3 text-sky-600 dark:text-sky-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-l-lg transition-colors"
                  >
                    <Minus className="w-4 h-4" />
                  </button>
                  <span className="px-5 text-lg font-semibold text-gray-800 dark:text-white">
                    {quantity}
                  </span>
                  <button
                    onClick={() =>
                    ...
                    className="px-4 py-3 text-sky-600 dark:text-sky-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-r-lg transition-colors"
                  >
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  ...
                  disabled={isAdding}
                  className="w-full sm:w-auto flex-1 bg-white dark:bg-gray-800 border-2 border-sky-600 dark:border-sky-400 text-sky-600 dark:text-sky-400 font-semibold py-3 px-6 rounded-lg transition-colors hover:bg-sky-50 dark:hover:bg-sky-900/20 text-base cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isAdding ? "Adding..." : "Add To Cart"}
                </button>
                <button
                  onClick={handleBuyNow}
                  className="w-full sm:w-auto flex-1 bg-sky-600 dark:bg-sky-500 hover:bg-sky-700 dark:hover:bg-sky-600 text-white font-semibold py-3 px-6 rounded-lg transition-transform text-base cursor-pointer"
                >
                  Buy Now
                </button>
              </div>
              <div className="flex flex-col gap-3 md:flex-row">
                <button
                  ...
                  className="flex items-center justify-center w-full md:w-1/3 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium py-3 px-4 rounded-lg transition-colors duration-200 cursor-pointer"
                >
                  <Heart
                ...
                <div className="flex gap-3 w-full md:w-2/3">
                  <button className="flex items-center justify-center w-1/2 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium py-3 px-4 rounded-lg transition-colors duration-200 cursor-pointer">
                    <MessageCircle className="w-5 h-5 mr-2" />
                    <span>Chat CS</span>
                  </button>
                  <button
                    onClick={() => setIsShareModalOpen(true)}
                    className="flex items-center justify-center w-1/2 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium py-3 px-4 rounded-lg transition-colors duration-200 cursor-pointer"
                  >
              ...
              <div className="space-y-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  <div className="mt-2 inline-block bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200 text-xs font-semibold px-3 py-1 rounded-full">
              ...
              <div className="space-y-4 border-t pt-6 border-gray-200 dark:border-gray-700">
                ...
                <div>
                  <h4 className="font-medium text-gray-800 dark:text-white mt-4 mb-2">
                    Dimensions
                  </h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                ...
                <button className="text-sky-600 dark:text-sky-400 font-medium text-sm mt-2 hover:underline">
                  Read More
                </button>
                <div className="mt-6 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800">
                  ...
                  <button className="mt-3 w-full bg-white dark:bg-gray-800 text-sky-600 dark:text-sky-400 border border-sky-600 dark:border-sky-400 font-semibold py-2 px-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm cursor-pointer">
                    See All Products
                  </button>
                </div>
              </div>
